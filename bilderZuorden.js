...
- später->dateinamen und serveradresse der bilder aus einer datenbank/cloudspeicher lesen und automatisch zuordnen
...
//schleife über die dateinamen der bilder
for( var i = 0; i < aBDateinamen.length; ++i){
	...
	for( var j = 0; j < pList.length; ++j){
		...
		//weitermachen solange der zeitstempel in dem dateinamen später als in dem aktuellen punkt war
		if( formatedTimeStamp > strPTimeStamp ){
			continue;
		}
		else{
			//die url als attribut des punktes hinzufügen und die schleife abbrechen->Bild kann nur einem Punktzugeordnet werden 
...
//liefert uhrzeit in dem format hh:mm:ss (00:15:30) zurück
